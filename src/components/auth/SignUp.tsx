        ...
        <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
            <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
                                ...
                                <div className="mt-5 flex gap-5 items-center">
                                        ...
                                        type="email" placeholder="Email" />
                                    {
                                        !isVerified ? (
                                            <button
                                                disabled={isSend}
                                                className={`flex cursor-pointer justify-center items-center h-12 w-24 rounded-md
                                                ${isSend ? "disabled:bg-slate-200" : " bg-slate-400"}
                                                ` }
                                            >Get Code</button>
                                        ) : (
                                ...
                                </div>
                                {
                                    ...
                                    <div className="mt-5 flex gap-5 items-center">
                                        <input
                                            ...
                                            type="text" />
                                        <button
                                            className='flex cursor-pointer justify-center items-center h-12 w-24 bg-slate-300 rounded-md'
                                        >Verify</button>
                                    </div>
                                }
                                <input
                ...
                <div className="flex-1 bg-indigo-100 text-center hidden lg:flex">
                    <div className="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat" style={bgImage}>
                    </div>
                </div>
            </div>
        </div>
